...
import tienda_pcoello.session.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private tienda_pcoello.session.CategoriaFacade ejbFacade;
    ...
    public void setEjbFacade(CategoriaFacade ejbFacade) {
